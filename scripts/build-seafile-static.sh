...
export JANSSON_PREFIX=$PWD/jansson
export SSL_PREFIX=$PWD/ssl
export QT_PREFIX=$PWD/qt
export SEAFILE_PREFIX=$PWD/seafile-$version
export LIBEVENT_PREFIX=$PWD/libevent
...
export COMMONFLAGS="-I$LIBEVENT_PREFIX/include -I$JANSSON_PREFIX/include -I$SSL_PREFIX/include -I$QT_PREFIX/include -I${SEAFILE_PREFIX}/include -static-libgcc"
export CFLAGS="$COMMONFLAGS"
export CXXFLAGS="$COMMONFLAGS -static-libstdc++"
#-fno-builtin, -static-libgcc -all-static
export LDFLAGS="-L$LIBEVENT_PREFIX/lib -L$JANSSON_PREFIX/lib -L$SSL_PREFIX/lib -L$QT_PREFIX/lib -I${SEAFILE_PREFIX}/lib -static-libgcc -static-libstdc++"
...
cd seafile-${version}/
./autogen.sh && ./configure --prefix=$PREFIX --disable-gui && make install
cd ..
...
# make static
cd seafile-client-${version}
gvim CMakeFiles/seafile-applet.dir/link.txt
